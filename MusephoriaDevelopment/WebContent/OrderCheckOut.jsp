	...
	Enter new Shipping Information<br><br>
     ...
     <table id="table 1" style="height: 37px; width: 22px; "  border="0" cellpadding="2" cellspacing="0" >
        <s:iterator items="{$CustomerData}" var="cd">
                <tr>
                    <td class="fo">Address:</td>&nbsp;
                        <td><input type="text" name="address1" value="${CustomerData.address}" style="height: 22px; width: 128px; " size="20"  /></td>

                </tr>
                <tr>
                    <td class="fo">City:</td>&nbsp;&nbsp;&nbsp;&nbsp;
                       <td> <input type="text" name="city1" value="${CustomerData.city}" style="height: 22px; width: 128px; " size="20" /></td>

                </tr>
                <tr>
                    <td class="fo">Province:</td>&nbsp;
                     <td>   <input type="text" name="province1" value="${CustomerData.province}"  style="height: 22px; width: 128px; " size="20" /></td>

                </tr>
                <tr>
                    <td class="fo">Country:</td>&nbsp;&nbsp;
                     <td>   <input type="text" name="Country1" value="${CustomerData.country}"style="height: 22px; width: 128px; " size="20" /></td>

                </tr>
                <tr>
                    <td class="fo">ZIP Code: </td>
                    <td><input type="text" name="zip1" value="${CustomerData.zipCode}"style="height: 22px; width: 128px; " size="20" /></td>

                </tr>
                <tr>
                    <td class="fo">Email:</td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                    <td><input type="text" name="Email1" value="${CustomerData.email}"style="height: 22px; width: 128px; " size="20" /></td>

                </tr>
                <tr>
                    <td class="fo">Phone:</td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       <td> <input type="text" name="Phone1" value="${CustomerData.phone}" style="height: 22px; width: 128px; " size="20" /></td>
