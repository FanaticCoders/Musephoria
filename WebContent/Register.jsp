...
<script language="javascript">
	...
	function checkMessage() {
		 ...
		 if ("${message}" == "Username Exists, Please select another username") {

			alert("Username Already exists,Please choose another");
			document.form.usr.focus();
		}
		if ("${message}" == "Passwords do not match, please enter a valid password") {
			...
			<fieldset>
				...
				<table>
					<tr>
						...
						<td><input class="form-fi" type="text" name="fname"
							maxlength="20" pattern="[a-zA-Z]+" required
							title="Please enter only alphabets">
					</tr>
					<tr>
						<td class="fo">Last Name :&nbsp;</td>
						<td><input class="form-fi" type="text" name="lname"
							maxlength="20" pattern="[a-zA-Z]+" required
							title="Please enter only alphabets">
					</tr>
					<tr>
						<td class="fo">Gender :&nbsp;</td>
						<td><select name="sex" class="form-fi">
					...
					<tr>
						...
						<td><input class="form-fi" type="text" name="usr"
							maxlength="15" required
							pattern="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{5,}$"
							title="Username must contain an Alphabet and a number with min length 5">
						<td>&nbsp;</td>
					</tr>
					<tr>
						<td class="fo">Password :&nbsp;</td>
						<td><input class="form-fi" type="password" name="pwd"
							size="20" maxlength="15" required
							pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d]{6,}$"
							title="Password must contain an Upper,Lower case,number with min length 6"></td>
					</tr>
					<tr>
						<td class="fo">Reconfirm Password :&nbsp;</td>
						<td><input class="form-fi" type="password" name="repwd"
							size="20" maxlength="15" required></td>
					</tr>
					<tr>
						<td class="fo">DOB :&nbsp;</td>
					...
					<tr>
						...
						<td><input class="form-fi" type="text" name="country"
							required /></td>
					</tr>
					<tr>
						<td class="fo">ZIP Code :&nbsp;</td>
						<td><input class="form-fi" type="text" name="zip" required
							pattern="[A-Za-z][0-9][A-Za-z] [0-9][A-Za-z][0-9]"
							placeholder="eg: K1G 3R5" /></td>
					</tr>
					<tr>
						<td class="fo">Email :&nbsp;</td>
						<td><input class="form-fi" type="email" name="email" required
							placeholder="Enter a valid email address"></td>
					</tr>
					<tr>
						<td class="fo">Phone :&nbsp;</td>
						<td><input class="form-fi" type="text" name="phone"
							maxlength="12" required pattern="^\d{3}-\d{3}-\d{4}$"
							placeholder="eg: 123-123-1234" /></td>
					</tr>
					<tr>
						<td class="fo">&nbsp;</td>
